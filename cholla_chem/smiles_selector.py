...
from cholla_chem.types import CompoundResolutionEntry
...
class SMILESSelector:
    ...
    def __init__(
        self,
        data: Dict[str, CompoundResolutionEntry],
    ...
    def select_smiles(
        self, compound_id: str, strategy: str | Callable = "consensus", **kwargs: Any
    ) -> Tuple[str, List[str]]:
        """
    ...
    def _strategy_consensus(
        self, smiles_dict: Dict[str, List[str]], **kwargs: Any
    ) -> tuple[str, List[str]]:
        """
